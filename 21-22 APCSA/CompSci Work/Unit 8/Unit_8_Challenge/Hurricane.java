...
public class Hurricane
{
    ...
    public String toString() {
        ...
        String formated = String.format("%-10s",year); 
        formated += String.format("%-20s",name);
        formated +=  String.format("%-10d",cat);
        formated +=  String.format("%-10d",pressure);
        formated +=  String.format("%8.3f",windspeed);
        return formated;
    }
